...
const FEATURES = [
  { emoji: "🌐", title: "Network Detective", desc: "Learn how data travels across the internet and spot suspicious activity before it becomes a threat." },
  { emoji: "🔐", title: "Code Breakers", desc: "Understand encryption and why it keeps your messages private. Crack codes and build your own ciphers." },
  { emoji: "🎭", title: "Social Engineering", desc: "Recognise manipulation tactics used by hackers. Learn to think critically about who you trust online." },
];
        ...
        <section className="max-w-[1200px] mx-auto px-6 md:px-10 pt-28 sm:pt-36 pb-16 sm:pb-24">
          <motion.div className="text-center"
            ...
            <div className="inline-block px-4 py-1.5 rounded-full text-sm font-bold mb-6"
              ...
              Ages 11-14 · 14 Weeks · 1 hour per week
            </div>

            <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-10">
              Motion-graphics driven lessons exploring networks, encryption, social engineering, and ethical hacking. Your teen will learn how the internet really works — and how to protect themselves in it.
            </p>
        ...
        <section className="max-w-[1200px] mx-auto px-6 md:px-10 py-16 sm:py-24">
          <ScrollReveal className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
              What You&apos;ll{" "}
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: GRAD, WebkitBackgroundClip: "text" }}>Explore</span>
            </h2>
          </ScrollReveal>
            ...
            {FEATURES.map((f, i) => (
              <ScrollReveal key={i} delay={i * 0.12}>
                <motion.div className="rounded-3xl p-6 h-full"
                  whileHover={{ y: -6, boxShadow: `0 0 40px ${PRIMARY}20` }}
                  style={{
          ...
          <ScrollReveal>
            <div className="rounded-3xl p-8 sm:p-14 text-center"
              ...
              <p className="text-gray-400 text-base sm:text-lg max-w-lg mx-auto mb-8">
                Be the first to know when Cyber Explorers launches. Sign up for early access.
              </p>
              <motion.a href="/signup"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
        ...
        <footer className="border-t py-8 px-6 md:px-10" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
          <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 flex-wrap">
              ...
              <a href="/cyber-explorers" className="text-xs font-bold transition-colors" style={{ color: ACCENT }}>Cyber Explorers</a>
