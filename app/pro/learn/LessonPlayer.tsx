            ...
            <main style={{ marginTop: 34 }}>
              ...
              <div style={{ marginTop: 26, display: "flex", gap: 12, flexWrap: "wrap" }}>
                {embedded ? (
                  ...
                  <>
                    <a href="/pro/course" style={{ fontFamily: T.display, fontSize: 14, fontWeight: 700, letterSpacing: "0.03em", padding: "12px 24px", borderRadius: 10, color: "#fff", textDecoration: "none", background: `linear-gradient(135deg, ${T.primary}, ${T.cyan})` }}>Back to all modules</a>
