 ...
 * Chakra Petch = Pro display lockups, Nunito = the friendly reading
 * body a beginner course lives on, Plex Mono = code and data. Exposed
 * as vars so /dev harnesses render with the literal fallbacks. */
