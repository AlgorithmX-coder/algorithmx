...
export const mission12: MissionManifest = {
    ...
    /* ------------------------------------------ cycle 2: the padlock */
    {
      ...
      intel: {
        beats: [
          ...
          "An unsealed one is a postcard — everyone en route can read it.",
        ...
        prediction: {
          ...
          options: [
            ...
            "The JOURNEY is sealed — nobody en route can read it",
            "The site has no ads",
          ],
          answer: 1,
          ...
          tells: [
            {
              id: "sealed",
              label: "The padlock",
              why: "Sealed envelope. Strangers en route see gibberish.",
            },
            {
              id: "postcard",
              label: "No padlock",
    ...
    /* ------------------------------------------ cycle 3: the postcard party */
    {
      ...
      fieldwork: {
        ...
        payload: {
          ...
          situation:
            "You're at a café on “FREE_COFFEE_WIFI”. You need to check your email, and the login page you've opened shows NO padlock.",
          ...
          options: [
            ...
            },
            {
              ...
              outcome:
                "The barista didn't wire the network and can't see who's snooping it. Padlocks vouch for journeys. People can't.",
            },
          ],
        },
      },
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              "Whoever named it that — possibly a laptop in seat 14C",
  ...
  debrief: {
    report: [
      "One ancient cipher made and broken by hand — and the lesson: 25 slides is no secret.",
      "The padlock decoded: sealed, postcard, end-to-end — three journeys, told apart.",
      "Café protocol set: known road or sealed envelope, always at least one.",
    ],
    realWorldMove:
      "This week: before typing anything private, glance for the padlock. On free Wi-Fi, glance twice — and when in doubt, use phone data.",
