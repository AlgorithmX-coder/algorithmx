...
// PLACEHOLDER COPY — the curriculum hasn't shipped yet; these are
// indicative themes for the marketing page. Source of truth for
// metadata (name, ageRange, emoji, duration, weeksCount, priceGBP)
// is the Product row fed in via props.
const FEATURES = [
...
/** "Ages 14–16 · 12 Weeks · 60 min/week" — hides weeksCount when 0
 *  (pre-launch products) so the chip doesn't read "0 Weeks". */
...
export default function CyberStartLanding({ product }: { product: Product }) {
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-10 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <motion.a href="/signup?course=cyberstart"
          ...
          <motion.div className="text-center"
            ...
            <motion.div className="relative mx-auto w-48 h-48 mb-10"
              ...
              <div className="relative w-full h-full rounded-full flex items-center justify-center"
                ...
                <CyberIconOrEmoji emoji={product.emoji} size={80} accent="lime" />
              </div>
            </motion.div>

            <div className="flex justify-center">
              <WaitlistForm
                courseSlug={product.slug as "cyberstart"}
                accent={PRIMARY}
                accentSoft={ACCENT}
                buttonGradient={GRAD}
            ...
            {/* Honest placeholder marker — set apart so it doesn't
                look broken, but tells visitors the curriculum is
          ...
          <ScrollReveal>
            <div className="rounded-3xl p-8 sm:p-14 text-center"
              ...
              <p className="text-gray-400 text-base sm:text-lg max-w-lg mx-auto mb-8">
                {product.name} launches soon. Get early access and be among the first to level up your skills.
              </p>
              <div className="flex justify-center">
                <WaitlistForm
                  courseSlug={product.slug as "cyberstart"}
