...
function FloatingIcons() {
  const icons = [
    { emoji: "🔒", top: "12%", left: "20%", delay: "0s", dur: "6s" },
    { emoji: "🔑", top: "25%", right: "15%", delay: "1s", dur: "7s" },
    { emoji: "⭐", top: "60%", left: "15%", delay: "2s", dur: "8s" },
    { emoji: "🛡️", top: "75%", right: "20%", delay: "0.5s", dur: "6.5s" },
    { emoji: "🔐", top: "40%", left: "70%", delay: "3s", dur: "9s" },
    { emoji: "✨", top: "85%", left: "45%", delay: "1.5s", dur: "7.5s" },
  ];
  return (
    <>
      {icons.map((ic, i) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-3xl p-7 sm:p-8"
            ...
            <p className="text-center text-gray-500 text-sm mt-6">
              ...
              <a href="/login" className="font-bold transition hover:opacity-80" style={{ color: "#8b5cf6" }}>
                Log In
              </a>
            </p>
          </div>
