...
export const WEEK_1: WeekContent = {
  ...
  bossQuestions: {
    ...
    hard: [
      ...
      { question: "Why is a 6-character password insecure even if 'random'?", answers: ["Modern computers can try all 6-character combinations in seconds", "6 is an unlucky number", "It's too long", "It needs emoji"], correctIndex: 0, explanation: "Length is the single biggest factor — 12+ characters is the modern minimum" },
