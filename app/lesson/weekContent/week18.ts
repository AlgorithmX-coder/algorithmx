  ...
  bossShowdown: {
    ...
    phases: [
      ...
      // phase - game, then art, then chat, before the goblin reaches them.
      {
        kind: "orderStrike",
        attack: 0,
        coach: "Beat the bell - log out of all three before the next class sits down!",
        intro: "The lab bell rings in seconds and three of your accounts are still open on the school computer - log out of every one before you leave.",
        steps: [
          { id: "reading", label: "LOG OUT of your reading account", icon: "📋" },
          { id: "maths", label: "LOG OUT of your math game", icon: "🎮" },
          { id: "email", label: "LOG OUT of your class email", icon: "💬" },
        ],
      },
      ...
      // shared screen - closed chests stay closed.
      {
        kind: "counterCard",
        attack: 1,
        coach: "Not your tablet, not your business - you know this one!",
        situation: "You borrowed your friend's tablet for a game, and their private messages suddenly pop up on the screen right in front of you.",
        situationIcon: "👀",
        cards: [
          { id: "handback", label: "LOOK AWAY, HAND IT STRAIGHT BACK, TELL THEM IT POPPED UP", icon: "🤫", isRight: true, note: "Eyes off, hand it back, and let them know so they can close it - Lock Master style." },
          { id: "readfast", label: "READ IT QUICK BEFORE IT DISAPPEARS", icon: "🙈", isRight: false, note: "A message popping up isn't an invitation - it's someone's private chest, even for a second." },
          { id: "screenshot", label: "SCREENSHOT IT TO READ LATER", icon: "📋", isRight: false, note: "Saving someone's private words is snooping you keep - close your eyes and hand it back." },
        ],
      },
      ...
      // across the house - pop NO on shared screens, ask first on your own.
      {
        kind: "deflectSort",
        attack: 2,
        coach: "Whose device is it? Shared or borrowed, pop it. Your own? That's a grown-up question!",
        actLabel: "POP IT - NO!",
        actIcon: "✋",
        passLabel: "ASK MOM FIRST",
        items: [
          { id: "hotel", label: "SAVE PASSWORD? - the tablet in the hotel lobby", icon: "🌍", act: true, note: "A new guest uses it every night - pop it, your keys leave WITH you." },
          { id: "watch", label: "SAVE PASSWORD? - your own smart-watch, only yours", icon: "🏷️", act: false, note: "That's yours - so it's a grown-up question, not an automatic pop." },
          { id: "friendlaptop", label: "SAVE PASSWORD? - your friend's laptop you borrowed for homework", icon: "🎮", act: true, note: "Borrowed means it goes home without you - keys stay in your pocket." },
          { id: "myphone", label: "SAVE PASSWORD? - your own phone at home", icon: "📱", act: false, note: "Your own device plus a grown-up's yes - that's the only maybe." },
          { id: "afterschool", label: "SAVE PASSWORD? - the shared computer at your after-school club", icon: "🏫", act: true, note: "A whole club shares that keyboard - never leave your keys in it." },
          { id: "ereader", label: "SAVE PASSWORD? - your birthday e-reader, only you use it", icon: "🎁", act: false, note: "Yours again - your grown-up helps decide where keys can live." },
        ],
      },
    ],
    weakPoints: [
      { question: "You finished on the library computer and you're rushing. You tap the little X to close the game window. Does that log you out?", answers: ["No - closing a window isn't logging out, you have to actually LOG OUT", "Yes - closing the window signs you out", "Yes - the library logs you out for you", "Yes - as long as you closed it quickly"], correctIndex: 0, explanation: "Closing a window just hides it, like tapping Home - your account stays open behind it. Only LOG OUT hands the computer back clean." },
      { question: "On the bus, the kid next to you falls asleep and their phone slips open in their bag, screen glowing. What's the hero move?", answers: ["Leave it alone - it's theirs, not a chance to look", "Have a quick scroll while they're asleep", "Check who they've been messaging", "Change their wallpaper for a laugh"], correctIndex: 0, explanation: "An unlocked phone that isn't yours is still a closed chest. Easy to peek never means okay to peek." },
      { question: "You're on Grandad's computer and the SAVE PASSWORD balloon pops up. Grandad says 'go on, save it, it's fine!' What's safest?", answers: ["Say no thanks - it's a shared computer, so your keys shouldn't stay on it", "Save it - a grown-up said yes", "Save it but tell nobody", "Save it, just this once"], correctIndex: 0, explanation: "Even with a kind yes, a shared computer keeps your keys for whoever's next. The ask-first rule only unlocks saving on your OWN device." },
    ],
    finisher: {
