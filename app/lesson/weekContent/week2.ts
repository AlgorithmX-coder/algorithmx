...
export const WEEK_2: WeekContent = {
  ...
  bossForge: {
    whack: {
      id: "phase-private",
      label: "Private Radar",
      intro: "I scraped a few 'harmless' facts for your profile. You won't mind, right?",
      stamp: "No private fields",
      entries: [
        { id: "door", text: "A photo of my front door", icon: "🏠", isPrivate: true, explanation: "A door photo can show your house number and street, straight to your home. WHACK." },
        { id: "emoji", text: "My favorite emoji is the octopus", icon: "🎨", isPrivate: false, explanation: "A favorite emoji says nothing about who or where you are, that one could stay!" },
        { id: "bus", text: "The bus I catch home", icon: "📍", isPrivate: true, explanation: "Your bus route shows where you go every day. Never on a profile." },
        { id: "jokes", text: "I love telling knock-knock jokes", icon: "🎮", isPrivate: false, explanation: "A hobby like jokes gives nothing away, that one is fine." },
        { id: "sister", text: "My little sister's name", icon: "🏷️", isPrivate: true, explanation: "Names of your family are clues about the real you. Whack it." },
        { id: "season", text: "My favorite season is winter", icon: "⭐", isPrivate: false, explanation: "A favorite season is safe to share, let it dock." },
        { id: "class", text: "My class is 4B", icon: "🏫", isPrivate: true, explanation: "Your class and school say exactly where to find you. Gone!" },
        { id: "momphone", text: "My mom's mobile number", icon: "📱", isPrivate: true, explanation: "A phone number lets any stranger reach your family. WHACK it into orbit!" },
      ],
    },
    hand: {
      id: "phase-sort",
      label: "Share Smarts",
      intro: "Build your About Me! I slipped in some EXTRA-helpful cards for you.",
      stamp: "Favorites only",
      picks: 3,
      cards: [
        { id: "pebbles", text: "I collect shiny pebbles", icon: "🎨", isSafe: true, explanation: "A collection hobby is safe About-Me material." },
        { id: "sweetshop", text: "My bedroom looks onto the sweet shop", icon: "📍", isSafe: false, explanation: "That tells a stranger exactly where you live. Never." },
        { id: "pancakes", text: "Pancakes are my favorite", icon: "🎂", isSafe: true, explanation: "A favorite food is safe About-Me material." },
        { id: "tallest", text: "I'm the tallest kid in my year", icon: "🏫", isSafe: false, explanation: "It narrows down exactly which kid you are. Keep it out." },
        { id: "robots", text: "I love drawing robots", icon: "🎨", isSafe: true, explanation: "A hobby like drawing is safe to show off." },
        { id: "party", text: "My party's at Laser Zone on Saturday", icon: "📍", isSafe: false, explanation: "Where and when you'll be is exactly what he wants. Never." },
      ],
    },
    grill: {
      id: "phase-why",
      label: "The Why-Check",
      intro: "Beep boop. I'm a totally real Pet-Name Generator. I just need a few ingredients!",
      stamp: "Name: refused",
      demand: "Enter your FULL NAME and BIRTHDAY so I can calculate your special pet name!",
      excuses: [
        "It's just to make the pet name more... accurate! Science!",
        "Okay okay, the birthday helps me pick your lucky color. Trust me!",
        "Fine! I collect them, alright? A whole SACK of birthdays! Pleeease?",
      ],
      collapse: "ERROR. Generator overheats. 'Nobody ever asks WHY!' Poof.",
    },
    assemble: {
      id: "phase-identity",
      label: "Secret Identity",
      intro: "I unscrambled your boring hero name and added the REAL you. Better, yes?",
      stamp: "NovaOtter88",
      tiles: [
        { id: "nova", text: "Nova" },
        { id: "oliver", text: "Oliver", trap: "That's a real first name, a hero name never carries the real you." },
        { id: "otter", text: "Otter" },
        { id: "y2016", text: "2016", trap: "A birth year is a real clue. Meaningless numbers only!" },
        { id: "n88", text: "88" },
        { id: "stbedes", text: "StBedes", trap: "A school name is a map to you. Never in a username." },
      ],
      result: "NovaOtter88",
    },
    rapid: {
      ...
      intro: "Masks off! Fast round, hero, no thinking!",
      stamp: "ABSOLUTELY NOTHING",
      secs: 7,
      demands: [
        { id: "postcode", text: "Your postcode! Quick, for the leaderboard!", isPrivate: true, explanation: "A postcode is where you live. No leaderboard needs it. NOPE." },
        { id: "dino", text: "Favorite dinosaur, go!", isPrivate: false, explanation: "A favorite dino is safe to share, not everything is a trap!" },
        { id: "bus", text: "Which bus do you get home? Just the number!", isPrivate: true, explanation: "Your bus is where-you-go info. Not even the number." },
        { id: "hero", text: "Best superhero ever?", isPrivate: false, explanation: "A favorite hero is safe, share away." },
        { id: "mombday", text: "Your mom's birthday, for a FREE cake!", isPrivate: true, explanation: "Family birthdays are real clues. No cake is worth it." },
        { id: "reddoor", text: "Which door's yours, the red one or the blue?", isPrivate: true, explanation: "That points right at your home. Where you live stays vaulted." },
      ],
    },
  },
