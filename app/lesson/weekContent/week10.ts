...
export const WEEK_10: WeekContent = {
  ...
  screens: [
    ...
    // 1 - ALERT: incident report
    {
      ...
      caption: "The Raccoon greased the next-video belt so it NEVER stops - and stocked the hole with wild claims and fishing comments. Kids sat down for one video and looked up two hours later. This week you learn to notice the pull... and climb out.",
      ...
      items: [
        ...
        },
        {
          ...
          steps: [
            ...
            { icon: "🎯", text: "A computer picked that exact picture for YOUR eyes - like sweets stacked at the checkout." },
    ...
    // 5 - Prove: FINISH
    {
      ...
      choices: [
        ...
        { text: "tidying up", isCorrect: false },
        { text: "outside", isCorrect: false },
      ],
    ...
    // 7 - Learn
    {
      ...
      content:
        "Videos can say ANYTHING. 'The moon is cheese!' 'This trick makes you taller overnight!' Saying it in a video doesn't make it true - anyone can film anything. So do what librarians do: WEIGH the claim. Put it on the scales against a real source - a book, a teacher, a grown-up who can check. Real facts balance. Wild claims fling right off.",
      bullets: [
        "Videos can say anything - anyone can film",
        "'A video said so' is NOT proof",
        "Weigh claims against a real source",
    ...
    // 8 - Game: SORT (conveyorSort re-dress - the Fact Scales)
    {
      ...
      items: [
        { id: "octopus", text: "Octopuses have three hearts", icon: "🧠", categoryId: "checks", explanation: "Your animal book agrees - three hearts, really! It balances on the scales." },
        { id: "cheese", text: "The moon is made of cheese - a video PROVED it", icon: "🌀", categoryId: "wild", explanation: "No real book anywhere says cheese-moon. A video saying it isn't proof - fling!" },
        { id: "honey", text: "Honey basically never goes off", icon: "✅", categoryId: "checks", explanation: "Checked and true - sealed honey keeps for ages and ages. It balances." },
        { id: "invisible", text: "Eat this sweet and turn INVISIBLE for an hour", icon: "🙈", categoryId: "wild", explanation: "Fun to imagine - but no source on Earth backs it. Wild claim, flung." },
        { id: "lightning", text: "Lightning is hotter than the sun's surface", icon: "⚡", categoryId: "checks", explanation: "Sounds wild but the science book AGREES - that's why we weigh instead of guess!" },
        { id: "school", text: "School is cancelled FOREVER - a YouTuber said so", icon: "🏫", categoryId: "wild", explanation: "Who would know? Your school and your grown-ups - and they say no. Flung." },
        { id: "space", text: "Astronauts float around inside the space station", icon: "🚀", categoryId: "checks", explanation: "Every space book and real NASA video agrees - it balances beautifully." },
        { id: "luck", text: "Send this to 5 friends or you'll have bad luck", icon: "🌀", categoryId: "wild", explanation: "Luck doesn't travel by message - that's a trick to make videos spread. Fling!" },
      ],
      hints: {
    ...
    // 10 - Recap · Concept 2 of 5
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Cheese-moons and forever-holidays - flung!",
    ...
    // 11 - Learn
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "[excited] Let's practise finding that exit - calm and quick!",
        ],
      },
    },
    ...
    // 17 - Prove: RECALL
    {
      ...
      choices: [
        ...
        { text: "Only your friends", isCorrect: false },
        { text: "Only other kids", isCorrect: false },
        { text: "The video maker's family", isCorrect: false },
      ],
    ...
    // 19 - Learn
    {
      ...
      content:
        "Here's a secret: when you've been watching a while, your BODY tells you first. Dry, blinky eyes. A jiggly leg. A stiff neck. The sky outside changed colour and you didn't notice. Those aren't bad things - they're your body ringing a friendly bell: 'been here a while!' The hero move is simple: notice the bell, pause the belt, and pick what happens next YOURSELF.",
      bullets: [
      ...
      scenarios: [
        ...
        },
        {
          ...
          choices: [
            ...
            { text: "That's my bell - time for something else", isSafe: true, consequence: "You NOTICED! Trampoline, snack, drawing, calling a mate - your eyes and legs said thank you in about two minutes." },
          ],
        },
        {
          ...
          choices: [
            ...
            { text: "Screen off - dinner time", isSafe: true, consequence: "You beat the countdown! The episode will wait patiently all night. Hot chips and family jokes won't." },
          ],
        },
      ],
      narration: {
    ...
    // 23 - Consolidation: Climb Out (W1 scanner engine, W10 content)
    {
      ...
      items: [
        ...
        { text: "Backing out of a not-for-kids video, then telling Mum", isStrong: true, explanation: "Notice, back out, tell - the calm escape, done perfectly." },
  ...
  bossQuestions: {
    easy: [
      { question: "When a video ends and the next one starts by itself, who picked it?", answers: ["The autoplay machine", "You did", "Your best friend", "Nobody - it's magic"], correctIndex: 0, explanation: "That's the belt - a machine built to keep you watching." },
      { question: "A video says the moon is made of cheese. What do you do?", answers: ["Weigh it against a real source", "Believe it - videos are proof", "Share it with 5 friends", "Eat some moon"], correctIndex: 0, explanation: "'A video said so' isn't proof - books, teachers and grown-ups can check." },
      { question: "Who lives in the comments under a video?", answers: ["Strangers", "Your classmates", "Your family", "Puppies"], correctIndex: 0, explanation: "Week 3 rules apply - no replies, no info, just watch and move on." },
    ],
    medium: [
      ...
      { question: "A comment says 'What school do you go to? Just curious!' What is it?", answers: ["A fishing comment - never answer", "A friendly question", "A school survey", "A quiz you should win"], correctIndex: 0, explanation: "Questions about YOU are fishing - your school stays yours." },
      { question: "Dry eyes, jiggly leg, the sky's gone dark outside. What's your body saying?", answers: ["'Been watching a while - time to pick something else'", "'One more video!'", "'You need glasses'", "Nothing at all"], correctIndex: 0, explanation: "That's the bell - notice it, pause the belt, choose what's next yourself." },
    ],
    hard: [
      { question: "Why does the countdown only give you 5 seconds before the next video?", answers: ["So you don't have time to ask 'do I want this?'", "To save electricity", "Because videos are 5 seconds long", "It's a rule for grown-ups"], correctIndex: 0, explanation: "The rush is designed - no thinking time means the belt keeps winning." },
      { question: "Why do wild claims spread so fast in videos?", answers: ["Shouty surprises get clicks - true or not", "Because they're always true", "Videos check facts first", "Teachers share them"], correctIndex: 0, explanation: "The machine rewards exciting, not true - that's why heroes weigh before believing." },
      { question: "Why is 'reply if you're too scared!' a trap even though it asks for no info?", answers: ["Any reply feeds the stranger and pulls you into their game", "Replies cost money", "It isn't a trap", "Because it's spelled wrong"], correctIndex: 0, explanation: "Dares fish for a REPLY - and any bite tells a stranger you're listening." },
    ],
  },
