...
/**
 * Content for the per-week "Mission Command" briefing (the weekIntro screen),
 * narrated by ATLAS — a steady man's voice (ElevenLabs "Daniel"), distinct
 * from Sarah, the in-lesson coach. Plays right after the intro video. Warm and
 * simple for ages 6–9: big title, one line, ATLAS auto-plays a ~15s welcome,
 * up to three picture-chips of what's coming, and a "Let's go!" button.
 * Kept as a named type so the per-week WEEK_INTROS map and the ScreenDef share it.
 */
