    ...
    // 5 - Game: CONNECT "Strings Attached" (stringsAttached, new engine)
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Here is what you do. Tap a prize balloon and I'll read its offer. Then tap the token on the counter that its string really leads to: your password, your money, your tap, or nothing at all, because some offers are real.",
    ...
    // 9 - Game: DIALS "The Believe-o-Meter" (believeOMeter, new engine)
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Here is what you do. A poster hangs above the dial and I'll read it. Tap the arrows to move the needle to Could be real, Hmm, check first, or No way. Then tap LOCK IT IN.",
    ...
    // 13 - Game: INSPECT "The Barker's Booth" (phishInspector, fully wired)
    {
      ...
      emails: [
        ...
        },
        {
          ...
          isPhishing: false,
          readAloud: "From Mrs. Patel at Maple Hill School. Library books due back Friday. Just a reminder that class four B's library books are due back this Friday. Thanks, Mrs. Patel.",
      ...
      narration: {
        ...
        lines: [
          ...
          "Here is what you do. A message opens. Tap its four clues one at a time: who sent it, the button, the clock, and the promise. I'll read what each clue shows. When all four are open, tap TRICK to zap it, or tap REAL to keep it.",
    ...
    // 17 - Game: MARK "The Name Tag Check" (nameTagCheck, new engine)
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Here is what you do. The real sender's name tag is on top. The sender to check hangs underneath, split into the same pieces. Compare each piece with the one above it. If a piece doesn't match, tap it to mark it SWAPPED. Tap it again to lift the mark. Then tap CLOSE THE BOOTH.",
    ...
    // 21 - Game: BUILD "The No-Bite Wall" (firewallBuilder, rebuilt from the orphaned canvas game)
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Here is what you do. A brick arrives in the tray and I'll read it. If it's a safe habit, tap a column of the wall to lay it in. If it's a bad habit, tap the bin to throw it out.",
    ...
    // five mirrors around the hall, one question per power, choices shuffled.
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Here is what you do. Tap a glowing mirror and it asks you a question. I'll read it. Tap the answer you believe. Get it right and the mirror clears. Clear all five, and the hall is yours.",
