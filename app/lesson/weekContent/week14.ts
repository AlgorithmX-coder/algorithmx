    ...
    // 5 - Game: EARS (HookSort, house skin). isScam true = the EARS ON call.
    {
      ...
      items: [
        ...
        { id: "kettle", text: "The kettle", icon: "🏠", isScam: false,
          ...
          why: "",
          explanation: "A kettle boils water and that is the whole of its job. No microphone, no ears, nothing to check." },
        ...
        { id: "teddy", text: "The old teddy bear", icon: "🧸", isScam: false,
          ...
          why: "",
          explanation: "An ordinary teddy is stuffing and stitching. No batteries, no microphone, and no ears at all." },
        ...
        { id: "lamp", text: "The reading lamp", icon: "💡", isScam: false,
          ...
          why: "",
          explanation: "A lamp makes light and nothing else. It has no way to hear a single thing." },
        ...
        { id: "clock", text: "The wind-up alarm clock", icon: "⏱️", isScam: false,
          ...
          why: "",
          explanation: "You wind it and it ticks. There is no microphone inside a clock with a key in the back." },
      ],
      hints: {
