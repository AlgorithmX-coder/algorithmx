...
export const WEEK_14: WeekContent = {
  ...
  screens: [
    ...
    // 4 - Game: SORT (hookSort re-dress - the Ears Check)
    {
      ...
      completeTitle: "House checked, Cyber Hero!",
          ...
          choices: [
            {
              ...
              isSafe: true,
              consequence: "The club stays secret because the password never touched the air. Proper spy work, Cyber Hero.",
            },
            {
    ...
    // 20 - Game: FIND (settingsSwitch re-dress - the Mute Safari)
    {
      ...
      narration: {
        ...
        lines: [
          ...
          "Patrol, point, flip. Go, Cyber Hero!",
        ],
      },
      coachLines: {
        speaker: "adam",
