  ...
  bossShowdown: {
    ...
    phases: [
      ...
      // per era, each week named on screen as it lands.
      {
        kind: "rush",
        attack: 0,
        coach: "Four old tricks in new coats, back to back - you've beaten every one of these before!",
        beats: [
          {
            id: "w4",
            callback: "WEEK 4'S POWER",
            prompt: "A message glows: 'Your prize is ready at 5tarmart-rewards.shop - claim now!' What's the tell?",
            promptIcon: "✉️",
            mode: "tap",
            options: [
              { id: "sender", label: "The address - 5tarmart starts with a 5 dressed up as an S", icon: "🔍", isRight: true, note: "" },
              { id: "prize", label: "The word 'prize' - real shops never run any prizes", icon: "🎁", isRight: false, note: "Shops do run real prizes - the number hiding in the name is the true tell." },
              { id: "night", label: "It came at night - all night-time messages are fake", icon: "📬", isRight: false, note: "Messages come at all hours - the swapped letter is what unmasks this one." },
            ],
            landedLine: "The number in disguise - caught in a blink!",
          },
          {
            id: "w9",
            callback: "WEEK 9'S POWER",
            prompt: "A copycat skids across the rooftop: 'BLAST RACERS 2 - FREE FULL GAME - by Game-Uploads-88'!",
            promptIcon: "🎭",
            mode: "tap",
            options: [
              { id: "zap", label: "ZAP IT - a copycat with a made-up seller, not the real studio", icon: "⚡", isRight: true, note: "" },
              { id: "install", label: "INSTALL IT - a free sequel is a lovely treat", icon: "📥", isRight: false, note: "Free copycats smuggle in sneaky passengers - the real sequel lives on the official page." },
              { id: "spell", label: "GIVE IT FIVE STARS TO BE POLITE", icon: "💬", isRight: false, note: "Stars don't make a fake real - the made-up uploader name gives it away. Zap it!" },
            ],
            landedLine: "Copycat zapped off the roof!",
          },
          {
            id: "w10",
            callback: "WEEK 10'S POWER",
            prompt: "'LAST CHANCE! This shiny sword is HALF PRICE - buy in the next 20 seconds!'",
            promptIcon: "🎡",
            mode: "hold",
            holdLabel: "HOLD THE PAUSE",
            holdIcon: "✋",
            holdSecs: 2.5,
            landedLine: "The countdown fizzled out - paused and beaten!",
          },
          {
            id: "w17",
            callback: "WEEK 17'S POWER",
            prompt: "A forgotten photo album flips itself to PUBLIC - the whole town could scroll it!",
            promptIcon: "🪞",
            mode: "hold",
            holdLabel: "FROST IT PRIVATE",
            holdIcon: "❄️",
            holdSecs: 2.5,
            landedLine: "Locked to friends-only - strangers get frosted glass.",
          },
        ],
      },
      ...
      // course, beaten by the thesis skill. The biggest clock, cracked calm.
      {
        kind: "shieldHold",
        attack: 1,
        coach: "His loudest rush yet - stay calm, hold steady, and let the clock run out on nothing!",
        holdLabel: "HOLD THE CALM SHIELD",
        holdIcon: "🛡️",
        holdSecs: 6,
        barrage: [
          "THREE SECONDS! TAP NOW OR LOSE IT ALL!",
          "The timer's nearly ZERO - HURRY, HURRY!",
          "Everyone but YOU has already grabbed it!",
          "No time to check - just TRUST me and GO!",
        ],
        burnoutLine: "The loudest countdown he ever built ran flat out to zero and nothing happened - a calm minute beats every ticking clock.",
      },
      ...
      // peek the plaque... it's blank. Then the graduate makes the call.
      {
        kind: "rush",
        attack: 2,
        coach: "The prettiest door yet - peek the plaque before you believe a single word!",
        beats: [
          {
            id: "peek",
            callback: "WEEK 16'S POWER",
            prompt: "A last shimmering door appears: 'STEP THROUGH FOR THE BEST PRIZE EVER!'",
            promptIcon: "🚪",
            mode: "hold",
            holdLabel: "HOLD TO PEEK THE PLAQUE",
            holdIcon: "🔍",
            holdSecs: 2.5,
            landedLine: "You peeked behind the paint... the plaque is BLANK.",
          },
          {
            id: "choice",
            callback: "THE GRADUATE'S CALL",
            prompt: "No real address hides behind the shimmer. Twenty weeks say...",
            promptIcon: "🧭",
            mode: "tap",
            options: [
              { id: "refuse", label: "NO PLAQUE, NO WALK-THROUGH", icon: "🚫", isRight: true, note: "" },
              { id: "risk", label: "PEEK ONCE MORE - MAYBE IT CHANGES", icon: "🎲", isRight: false, note: "A blank plaque stays blank however long you stare - a door with no address never gets walked through." },
              { id: "knock", label: "ASK THE DOOR TO PROMISE IT'S SAFE", icon: "✊", isRight: false, note: "Doors can promise anything - words are paint, and only a real plaque tells the truth." },
            ],
    ...
    weakPoints: [
      { question: "A text from 'FastShip' says a package needs a small fee at a link or it goes back, but you never ordered anything. The smartest move is...", answers: ["Don't tap - real deliveries don't chase tiny fees through strange links", "Pay the small fee - it's only tiny", "Tap fast so the package isn't sent back", "Reply asking them what the package is"], correctIndex: 0, explanation: "A tiny fee is a small ask hiding a big grab, and a package you never ordered can't really be yours - twenty weeks say don't tap." },
      { question: "A pop-up screams the offer 'EXPLODES in 5 seconds - decide NOW!' What does a calm hero know?", answers: ["Anything that won't let you stop and think is a trick - real offers can wait", "Five seconds is plenty of time, better hurry", "'Explodes' just means it's a special deal", "You should tap it before it disappears"], correctIndex: 0, explanation: "The rush IS the trap. An honest offer never panics you into deciding, so a calm minute beats every ticking clock." },
      { question: "A friend forwards a link: 'this free-coins site really works, I promise!' Even from a friend, the rule is...", answers: ["Check where the door really goes - a friend can be fooled too", "Trust it - your friend said it works", "Tap it, because a friend sent it", "Forward it on to more friends first"], correctIndex: 0, explanation: "A link is still a door even from a friend, and friends get tricked too. No real address, no walk-through, whoever sends it." },
    ],
    finisher: {
