...
const BUILDS = {
  ...
  "week19-intro": {
    out: "public/videos/module-19-intro.mp4",
    shots: [
      { clip: "intro-s1" },
      { clip: "intro-s2", vo: { file: "intro-s2", at: 2.0, duck: 0.35 } },
      { clip: "intro-s3" },
      ...
      { clip: "intro-s7" },
      { clip: "intro-s8" },
      // 4.83s line (atempo 1.07) in a 5.09s clip - starts immediately.
      { clip: "intro-s9", vo: { file: "intro-s9", at: 0.2, duck: 0.35 } },
    ],
    endCard: { lines: ["WEEK 19", "YOU'RE THE EXPERT"], hold: 2.5 },
  },
  "week19-outro": {
    out: "public/videos/module-19-outro.mp4",
    shots: [
      { clip: "outro-s1" },
      { clip: "outro-s2" },
      { clip: "outro-s3" },
      // 4.73s line (atempo 1.04) in a 5.09s clip - starts immediately.
      { clip: "outro-s4", vo: { file: "outro-s4", at: 0.2, duck: 0.35 } },
      { clip: "outro-s5" },
    ],
    endCard: { lines: ["FAMILY PROTECTED!", "YOU DID IT, CYBER HERO!"], hold: 2.5 },
  },
  "week20-intro": {
    out: "public/videos/module-20-intro.mp4",
    shots: [
      { clip: "intro-s1", vo: { file: "intro-s1", at: 2.5, duck: 0.35 } },
      { clip: "intro-s2" },
      { clip: "intro-s3" },
      { clip: "intro-s4" },
      { clip: "intro-s5" },
    ...
    endCard: { lines: ["WEEK 20", "THE FINAL MISSION"], hold: 2.5 },
  },
  "week20-outro": {
    out: "public/videos/module-20-outro.mp4",
    shots: [
      { clip: "outro-s1" },
      { clip: "outro-s2" },
      { clip: "outro-s3", vo: { file: "outro-s3", at: 5.0, duck: 0.35 } },
      { clip: "outro-s4" },
      { clip: "outro-s5", vo: { file: "outro-s5", at: 3.0, duck: 0.35 } },
    ],
    endCard: { lines: ["COURSE COMPLETE!", "YOU ARE A CYBER HERO!"], hold: 3.0 },
  },
};
