...
const SCRIPTS = {
  ...
  14: "Welcome back, Cyber Hero. All sorts of things in your home can listen, and a few can watch: the speaker, the telly, the console, sometimes even a toy. None of them are out to get you, and that is exactly why it is worth knowing about them. Here's your mission this week. You're going to learn which things in a room have ears and which truly do not, that a helpful speaker keeps a diary a grown-up can open and empty, that a lens which is awake nearly always shows a little light, that saying something out loud near a device records it just as surely as typing it, and that every one of these gadgets has switches you are allowed to flip with a grown-up. And here's why that matters so much. Once you can do all of that, nothing in your own home can listen in on you by accident, and you will know exactly what to do about it if it does. You learn the skill, and you are protected. Lamps on, Cyber Hero. Let's begin.",
  ...
  16: "Welcome back, Cyber Hero. Every link you tap and every code you scan is a DOOR, and the sign painted on a door was painted by whoever built it. Here is your mission this week. You are going to learn that the sign promises nothing and the little address plate is the only true part, that a door has to prove it is one of YOURS rather than you proving it is bad, that a fake code gets stuck over a real one and looks perfectly flat so you press a corner instead of staring, that a link has a pane you can read while a code is frosted glass nobody can read, and that when you genuinely cannot tell, the barrier goes out and a grown-up comes over. And here is why that matters so much. Once you can do all of that, no painted sign and no sticker and no shouting countdown can walk you through a door you never chose. You learn the skill, and you are protected. Into the maze, Cyber Hero. Let us begin.",
